...
public class ClienteBean implements ClienteViewModel, Serializable {
    ...
    public void guardarCliente() {
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage("Éxito", "Cliente registrado correctamente"));
            limpiarFormulario();
            cargarClientes();
        } catch (Exception e) {
            FacesContext.getCurrentInstance().addMessage(null,
    ...
    public void actualizarCliente() {
        if (clienteSeleccionado != null) {
            try {
                ...
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage("Éxito", "Cliente actualizado correctamente"));
                cargarClientes();
            } catch (Exception e) {
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", e.getMessage()));
    ...
    public void eliminarCliente() {
        if (clienteSeleccionado != null) {
            try {
                clienteInteractor.eliminarCliente(clienteSeleccionado.getIdCliente());
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage("Éxito", "Cliente eliminado correctamente"));
                cargarClientes();
            } catch (Exception e) {
                FacesContext.getCurrentInstance().addMessage(null,
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", e.getMessage()));
